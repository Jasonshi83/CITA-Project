        ...
        <div class="row">
            <div class="col-lg-4 lg-md-4 col-sm-12 align-self-center">
                <a class="logo-white" href="#"><img
                    ...
                    ></a>
                <div class="content">
                    CITANZ is a non-profitable organisation to connect and bind all Chinese IT professionals in New
                    Zealand together.
                </div>
            </div>
                ...
                <div class="row row-side">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-3 col-xs-6 footer-bottom">
                        ...
                        <div class="footer-menu QR-code">
                            <img src="https://citanz-api.leochen.co.nz/assets/Uploads/d0fdd8c069/cita-qrcode.svg"
                                 alt="CITANZ Wechat QR Code">
                        </div>
                    </div>
                </div>
            </div>
